...
- *MYSQL_ROOT_PASSWORD*: REMOVED-CREDENTIAL
- *MYSQL_USER*: maybe
- *MYSQL_PASSWORD*: REMOVED-CREDENTIAL
- *MYSQL_DATABASE*: ite3068

### Arcus

Pulling from [ruo91/arcus](https://hub.docker.com/r/ruo91/arcus/) and some appendix scripts for REMOVED-CREDENTIAL server.
See `arcus/install.sh`. It provide arcus to REMOVED-CREDENTIAL server list and set up zookeeper and REMOVED-CREDENTIAL.
...
*Because, arcus and REMOVED-CREDENTIAL require settins after container started.*
