...
class mysql_stat:
    ...
    def push_db(self, name, unix_sock, id, pw):
        ...
        self.name_conn_map[name] = pymysql.connect(host='0.0.0.0', unix_socket=unix_sock, user=id, passwd=pw)
    ...
    def collect(self):
        ...
        for name, conn in self.name_conn_map.items():
            ...
            try:
                ...
                self.name_conn_map[name] = pymysql.connect(host='0.0.0.0', unix_socket=ret[0], user=ret[1], passwd=ret[2])
